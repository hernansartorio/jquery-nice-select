/*  jQuery Airbo Nice Select
    https://github.com/weilandia/jquery-nice-select
  ...
  $.fn.niceSelect = function(method) {
    ...
    function create_nice_select($select) {
      ...
      $options.each(function(i) {
        ...
        var group = $option.parents('optgroup').data('target') || null;

        var $optionListItem = $('<li/>')
          .data($.extend($option.data(), { value: $option.val(), display: display, group: group }))
          .addClass('option' +
      ...
      $optgroups.each(function(i, group) {
        ...
        $dropdown.find('ul li').filter(function() {
          return $(this).data('group') == $(group).data('target');
        })
